...
Controls:
* **[Image Carousel](https://github.com/acastr7/Xamarin.Plugins/tree/master/ImageCarousel)** for Xamarin.Forms
...
* Ensure that Assembly Names are the same in all projects!
...
#### Contributors
* [acastr7](https://github.com/acastr7)
